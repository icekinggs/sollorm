...
from app.routers import agent_tokens, agents, alerts, auth, groups, install, notifications, patches, rdp, remote_access, remote_screen, script_executions
...
@app.get("/")
async def root():
    return {"name": "SolloRMM API", "version": "0.5.4", "status": "ok"}
